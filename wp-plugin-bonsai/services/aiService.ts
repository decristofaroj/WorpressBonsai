...
// Fix: Updated function signatures to accept ChatMessage array for conversational context.
...
// Fix: Updated function signature to include local analysis results for better packaging.
