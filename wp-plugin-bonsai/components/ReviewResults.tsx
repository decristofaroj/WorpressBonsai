...
import { SecurityIcon, PerformanceIcon, BestPracticesIcon, InteroperabilityIcon, CodeQualityIcon } from './icons/CategoryIcons';
import { CriticalIcon, WarningIcon, InfoIcon } from './icons/SeverityIcons';
