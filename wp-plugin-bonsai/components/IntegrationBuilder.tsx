...
// Fix: Imported AIModel and ProviderStatus types to support multi-provider functionality.
import type { IntegrationResponse, AIModel, ProviderStatus } from '../types';
import { CodeResultViewer } from './CodeResultViewer';
import { EmptyState } from './EmptyState';

// Fix: Added props interface to receive provider status and enabled models.
...
export function IntegrationBuilder({ providerStatus, enabledModels }: IntegrationBuilderProps): React.ReactNode {
    ...
    // Fix: Initialize selected model from the list of enabled models.
    ...
    const handleSubmit = useCallback(async () => {
        ...
        setResult(null);
        try {
            // Fix: Pass providerStatus to the generateIntegration service call.
